...
async function addListItem(key) {
    ...
    await fetch('api.php?action=save_list_item', { method: 'POST', body: fd });
...
async function deleteListItem(id) {
    ...
    await fetch(`api.php?action=delete_list_item&id=${id}&force_delete=1`, { method: 'DELETE' });
    await loadLists();
    showToast("Eliminado");
}
...
async function savePortfolio(e) {
    ...
    await fetch('api.php', { method: 'POST', body: fd }); await loadPortfolio(); toggleLoading(false); document.getElementById('portfolio-form').reset();
}
async function deleteArt(id) { await fetch(`api.php?action=delete_portfolio&id=${id}`); loadPortfolio(); }
...
async function saveService(e) {
    ...
    await fetch('api.php?action=save_service', { method: 'POST', body: fd }); await loadServices(); toggleLoading(false); document.getElementById('service-form').reset();
}
async function deleteService(id) { await fetch(`api.php?action=delete_service&id=${id}`); loadServices(); }
...
async function saveBlog(e) {
    ...
    await fetch('api.php?action=save_blog', { method: 'POST', body: fd }); await loadBlog(); toggleLoading(false); document.getElementById('blog-form').reset();
}
async function deleteBlog(id) { await fetch(`api.php?action=delete_blog&id=${id}`); loadBlog(); }